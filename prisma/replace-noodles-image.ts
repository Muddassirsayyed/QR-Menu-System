...
const SOURCE_IMAGE = "C:\\Users\\sayye\\.gemini\\antigravity\\brain\\bf301cdf-b633-40e3-bd6e-02be6ad842cd\\media__1781616815181.jpg";

async function main() {
  console.log("🥢 Replacing Veg Hakka Noodles images in database and filesystem...");
  ...
  console.log("🏁 Completed Veg Hakka Noodles image replacement!");
}
